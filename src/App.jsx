...
function GuidePage() {
  return <>
    ...
    <main id="top" className="wrap">
      <section className="hero"><div><span className="k">BRAND GUIDE · PESSOAS + IA</span><h1>Uma marca leve,<br/>divertida e acolhedora.</h1><p className="lead">A entrada visual para o sistema vigente da Beegloo. Regras, fontes de verdade e processos completos vivem na documentação canônica.</p><div className="hero-actions"><a className="primary-link" href="/docs">Explorar documentação</a><a className="secondary-link" href="/llms.txt">Contexto para IA</a></div></div></section>
      ...
      <Section id="contexts" tone="blue" icon="✣" title="Como usar" lead="Escolha a menor entrada adequada ao trabalho e aprofunde somente quando necessário."><div className="grid four"><article className="card"><h3>Para pessoas</h3><p>Leia e navegue pela fonte canônica vigente.</p><a className="card-link" href="/docs">Abrir documentação →</a></article><article className="card"><h3>Para agentes de IA</h3><p>Comece pelo roteador e carregue o contexto da intenção.</p><a className="card-link" href="/llms.txt">Abrir roteador →</a></article><article className="card"><h3>Para criar</h3><p>Combine o guide com briefing, conteúdo e assets do trabalho.</p><a className="card-link" href="/docs?doc=templates%2Fcreative-brief.md#docs">Abrir creative brief →</a></article><article className="card"><h3>Para continuar</h3><p>Preserve decisões aprovadas com um handoff verificável.</p><a className="card-link" href="/docs?doc=ai%2Fcreative-handoff.md#docs">Abrir protocolo →</a></article></div><div className="ai"><span className="k">ENTRADA PARA IA</span><h3>Um link curto, contextos específicos.</h3><p>O roteador público direciona cada agente para identidade, canal, tarefa ou workflow sem carregar todo o histórico editorial.</p><a className="docs-link" href="/llms.txt">Abrir contexto para IA →</a></div></Section>
    </main>
